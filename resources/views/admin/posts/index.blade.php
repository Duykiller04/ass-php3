                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex mt-3">
                                            <a href="{{ route('posts.show', $item) }}" class="btn btn-info mb-3">Xem</a>
                                            <a href="{{ route('posts.edit', $item) }}" class="btn btn-warning mb-3 ms-3 me-3">Sửa</a>
