                    ...
                    <div class="live-preview">
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select name="category_id" id="category_id" class=" form-control js-example-basic-single" disabled>
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="author" id="author" class="form-control" value="{{ $post->user->name }}" disabled>
                            </div>

                            <div class="col-lg-4">
                                <label for="name">Tiêu đề tin</label>
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="Enter name" value="{{ $post->name }}" disabled>
                            </div>

                            <div class="col-lg-8">
                                <label for="description">Mô tả</label>
                                <textarea class="form-control" name="description" id="description" disabled>{{ $post->description }}</textarea>
                            </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-check form-switch form-switch-md mb-3 mt-4" dir="ltr">
                                    ...
                                    <input type="checkbox" name="is_show_home" id="is_show_home" class="form-check-input"
                                        value="1" @if ($post->is_show_home == 1) checked @endif disabled>
                                </div>
